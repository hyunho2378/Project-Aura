 ...
 * Brand Story Page
 * 
 * - Transparent background (uses global Deep Navy theme)
 * - Glassmorphism cards
            ...
            <section className="py-24 md:py-32 relative overflow-hidden">
                <div className="relative max-w-screen-xl mx-auto px-6 lg:px-16">
                    ...
                    >
                        ...
                        {/* Description - Korean (Sans-serif) with word-break: keep-all */}
                        <p className="font-sans text-lg md:text-xl text-white/60 leading-relaxed whitespace-pre-line"
                ...
                <div className="max-w-screen-xl mx-auto px-6 lg:px-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        ...
                        >
                            ...
                            <p className="font-sans text-white/50 leading-relaxed" style={{ wordBreak: 'keep-all' }}>
                ...
                <div className="relative max-w-screen-xl mx-auto px-6 lg:px-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {brandContent.values.map((value, index) => (
                            ...
                            >
                                {/* Number */}
                                <span className="text-[11px] font-sans text-purple-400/60 tracking-[0.15em] mb-4 block">
                                ...
                                {/* Description - Korean (Sans-serif) */}
                                <p className="font-sans text-sm text-white/40 leading-relaxed" style={{ wordBreak: 'keep-all' }}>
                                    {value.desc}
                                </p>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 border-t border-white/5">
                <div className="max-w-screen-xl mx-auto px-6 lg:px-16 text-center">
                    ...
                    >
                        ...
                        <p className="font-sans text-white/50 mb-8" style={{ wordBreak: 'keep-all' }}>
